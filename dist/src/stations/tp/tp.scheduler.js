...
var TpSchedulerService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.TpSchedulerService = void 0;
...
(0, dotenv_1.config)();
let TpSchedulerService = TpSchedulerService_1 = class TpSchedulerService {
    constructor(tpService, configService, prismaService) {
        this.tpService = tpService;
        this.configService = configService;
        this.prismaService = prismaService;
        this.logger = new common_1.Logger(TpSchedulerService_1.name);
    }
    async handleCron() {
...
exports.TpSchedulerService = TpSchedulerService;
__decorate([
    (0, schedule_1.Cron)(process.env.TP_CRON_UPDATE_INTERVAL),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], TpSchedulerService.prototype, "handleCron", null);
exports.TpSchedulerService = TpSchedulerService = TpSchedulerService_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [tp_service_1.TpService,
        config_1.ConfigService,
        prisma_service_1.PrismaService])
], TpSchedulerService);
//# sourceMappingURL=tp.scheduler.js.map